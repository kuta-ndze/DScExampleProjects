...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # TASK 2: Add a pie chart to show the total successful launches count for all
...
# Add computation to callback function and retain graph
def get_pie_chart(entered_site):
     ...
     if entered_site == 'ALL':
         ...
         given_site = spacex_df[spacex_df['Launch Site'] == entered_site]
         fig = px.pie(given_site,
         names = 'class',
         title= 'Launch site by: ' + entered_site)
         return fig                            
